...
```{r}
# Import text data
tweets <- read.csv("~/R Scripts/coffee.csv", stringsAsFactors = FALSE)
...
#import example_text
example_text <- read_csv("example_text.csv")
...
coffee_dtm <- DocumentTermMatrix(tweets_corp)
